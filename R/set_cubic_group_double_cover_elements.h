...
#define _SET_CUBIC_GROUP_DOUBLE_COVER_ELEMENTS_H
  ...
  strcpy ( cubic_group_double_cover_rotations[0].name, "NA" )
  ...
  cubic_group_double_cover_rotations[1].w    = pi
  strcpy ( cubic_group_double_cover_rotations[1].name, "NA" )
  ...
  cubic_group_double_cover_rotations[2].w    = pi
  strcpy ( cubic_group_double_cover_rotations[2].name, "NA" )
  ...
  cubic_group_double_cover_rotations[3].w    = pi
  strcpy ( cubic_group_double_cover_rotations[3].name, "NA" )
  ...
  cubic_group_double_cover_rotations[4].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[4].name, "NA" )
  ...
  cubic_group_double_cover_rotations[5].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[5].name, "NA" )
  ...
  cubic_group_double_cover_rotations[6].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[6].name, "NA" )
  ...
  cubic_group_double_cover_rotations[7].w    = pi/2
  strcpy ( cubic_group_double_cover_rotations[7].name, "NA" )
  ...
  cubic_group_double_cover_rotations[8].w    = pi/2
  strcpy ( cubic_group_double_cover_rotations[8].name, "NA" )
  ...
  cubic_group_double_cover_rotations[9].w    = pi/2
  strcpy ( cubic_group_double_cover_rotations[9].name, "NA" )
  ...
  cubic_group_double_cover_rotations[10].w    = -pi/2
  strcpy ( cubic_group_double_cover_rotations[10].name, "NA" )
  ...
  cubic_group_double_cover_rotations[11].w    = -pi/2
  strcpy ( cubic_group_double_cover_rotations[11].name, "NA" )
  ...
  cubic_group_double_cover_rotations[12].w    = -pi/2
  strcpy ( cubic_group_double_cover_rotations[12].name, "NA" )
  ...
  cubic_group_double_cover_rotations[13].w    = 3*pi/2
  strcpy ( cubic_group_double_cover_rotations[13].name, "NA" )
  ...
  cubic_group_double_cover_rotations[14].w    = 3*pi/2
  strcpy ( cubic_group_double_cover_rotations[14].name, "NA" )
  ...
  cubic_group_double_cover_rotations[15].w    = 3*pi/2
  strcpy ( cubic_group_double_cover_rotations[15].name, "NA" )
  ...
  cubic_group_double_cover_rotations[16].w    = -3*pi/2
  strcpy ( cubic_group_double_cover_rotations[16].name, "NA" )
  ...
  cubic_group_double_cover_rotations[17].w    = -3*pi/2
  strcpy ( cubic_group_double_cover_rotations[17].name, "NA" )
  ...
  cubic_group_double_cover_rotations[18].w    = -3*pi/2
  strcpy ( cubic_group_double_cover_rotations[18].name, "NA" )
  ...
  cubic_group_double_cover_rotations[19].w    = 2*pi/3
  strcpy ( cubic_group_double_cover_rotations[19].name, "NA" )
  ...
  cubic_group_double_cover_rotations[20].w    = 2*pi/3
  strcpy ( cubic_group_double_cover_rotations[20].name, "NA" )
  ...
  cubic_group_double_cover_rotations[21].w    = 2*pi/3
  strcpy ( cubic_group_double_cover_rotations[21].name, "NA" )
  ...
  cubic_group_double_cover_rotations[22].w    = 2*pi/3
  strcpy ( cubic_group_double_cover_rotations[22].name, "NA" )
  ...
  cubic_group_double_cover_rotations[23].w    = -2*pi/3
  strcpy ( cubic_group_double_cover_rotations[23].name, "NA" )
  ...
  cubic_group_double_cover_rotations[24].w    = -2*pi/3
  strcpy ( cubic_group_double_cover_rotations[24].name, "NA" )
  ...
  cubic_group_double_cover_rotations[25].w    = -2*pi/3
  strcpy ( cubic_group_double_cover_rotations[25].name, "NA" )
  ...
  cubic_group_double_cover_rotations[26].w    = -2*pi/3
  strcpy ( cubic_group_double_cover_rotations[26].name, "NA" )
  ...
  cubic_group_double_cover_rotations[27].w    = 4*pi/3
  strcpy ( cubic_group_double_cover_rotations[27].name, "NA" )
  ...
  cubic_group_double_cover_rotations[28].w    = 4*pi/3
  strcpy ( cubic_group_double_cover_rotations[28].name, "NA" )
  ...
  cubic_group_double_cover_rotations[29].w    = 4*pi/3
  strcpy ( cubic_group_double_cover_rotations[29].name, "NA" )
  ...
  cubic_group_double_cover_rotations[30].w    = 4*pi/3
  strcpy ( cubic_group_double_cover_rotations[30].name, "NA" )
  ...
  cubic_group_double_cover_rotations[31].w    = -4*pi/3
  strcpy ( cubic_group_double_cover_rotations[31].name, "NA" )
  ...
  cubic_group_double_cover_rotations[32].w    = -4*pi/3
  strcpy ( cubic_group_double_cover_rotations[32].name, "NA" )
  ...
  cubic_group_double_cover_rotations[33].w    = -4*pi/3
  strcpy ( cubic_group_double_cover_rotations[33].name, "NA" )
  ...
  cubic_group_double_cover_rotations[34].w    = -4*pi/3
  strcpy ( cubic_group_double_cover_rotations[34].name, "NA" )
  ...
  cubic_group_double_cover_rotations[35].w    = pi
  strcpy ( cubic_group_double_cover_rotations[35].name, "NA" )
  ...
  cubic_group_double_cover_rotations[36].w    = pi
  strcpy ( cubic_group_double_cover_rotations[36].name, "NA" )
  ...
  cubic_group_double_cover_rotations[37].w    = pi
  strcpy ( cubic_group_double_cover_rotations[37].name, "NA" )
  ...
  cubic_group_double_cover_rotations[38].w    = pi
  strcpy ( cubic_group_double_cover_rotations[38].name, "NA" )
  ...
  cubic_group_double_cover_rotations[39].w    = pi
  strcpy ( cubic_group_double_cover_rotations[39].name, "NA" )
  ...
  cubic_group_double_cover_rotations[40].w    = pi
  strcpy ( cubic_group_double_cover_rotations[40].name, "NA" )
  ...
  cubic_group_double_cover_rotations[41].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[41].name, "NA" )
  ...
  cubic_group_double_cover_rotations[42].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[42].name, "NA" )
  ...
  cubic_group_double_cover_rotations[43].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[43].name, "NA" )
  ...
  cubic_group_double_cover_rotations[44].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[44].name, "NA" )
  ...
  cubic_group_double_cover_rotations[45].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[45].name, "NA" )
  ...
  cubic_group_double_cover_rotations[46].w    = -pi
  strcpy ( cubic_group_double_cover_rotations[46].name, "NA" )
  ...
  cubic_group_double_cover_rotations[47].w    = 2*pi
  strcpy ( cubic_group_double_cover_rotations[47].name, "NA" )
