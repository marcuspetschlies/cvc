...
inline char * init_1level_ctable ( int const N0 ) {
  return( ( char *) calloc ( N0 , sizeof( char ) ) );
...
inline char ** init_2level_ctable (int const N0, int const N1 ) {
  char * s__ = NULL;
  s__ = init_1level_ctable ( N0*N1);
  if ( s__ == NULL ) return( NULL );

  char ** s_ = ( char **) malloc( N0 * sizeof( char *) );
...
inline char *** init_3level_ctable (int const N0, int const N1, int const N2 ) {
  char ** s__ = NULL;
...
inline char **** init_4level_ctable (int const N0, int const N1, int const N2, int const N3 ) {
  char *** s__ = NULL;
...
inline char ***** init_5level_ctable (int const N0, int const N1, int const N2, int const N3, int const N4 ) {
  char **** s__ = NULL;
...
inline char ****** init_6level_ctable (int const N0, int const N1, int const N2, int const N3, int const N4, int const N5 ) {
  char ***** s__ = NULL;
...
inline char ******* init_7level_ctable (int const N0, int const N1, int const N2, int const N3, int const N4, int const N5, int const N6 ) {
  char ****** s__ = NULL;
...
inline char ******** init_8level_ctable (int const N0, int const N1, int const N2, int const N3, int const N4, int const N5, int const N6, int const N7 ) {
  char ******* s__ = NULL;
