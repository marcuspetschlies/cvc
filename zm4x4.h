...
static inline void zm4x4_eq_zm4x4_ti_zm4x4_pl_zm4x4_ti_co (double _Complex **r, double _Complex **s, double _Complex **t, double _Complex **u, double _Complex c ) {
  ...
  memcpy( ss, s[0], 16*sizeof(double _Complex) );
  memcpy( tt, t[0], 16*sizeof(double _Complex) );
  r[0][ 0] = ss[ 0] * tt[ 0] + u[0][ 0] * c + ss[ 1] * tt[ 4] + u[0][ 0] * c + ss[ 2] * tt[ 8] + u[0][ 0] * c + ss[ 3] * tt[12] + u[0][ 0] * c;
  r[0][ 1] = ss[ 0] * tt[ 1] + u[0][ 1] * c + ss[ 1] * tt[ 5] + u[0][ 1] * c + ss[ 2] * tt[ 9] + u[0][ 1] * c + ss[ 3] * tt[13] + u[0][ 1] * c;
  r[0][ 2] = ss[ 0] * tt[ 2] + u[0][ 2] * c + ss[ 1] * tt[ 6] + u[0][ 2] * c + ss[ 2] * tt[10] + u[0][ 2] * c + ss[ 3] * tt[14] + u[0][ 2] * c;
  r[0][ 3] = ss[ 0] * tt[ 3] + u[0][ 3] * c + ss[ 1] * tt[ 7] + u[0][ 3] * c + ss[ 2] * tt[11] + u[0][ 3] * c + ss[ 3] * tt[15] + u[0][ 3] * c;
  r[0][ 4] = ss[ 4] * tt[ 0] + u[0][ 4] * c + ss[ 5] * tt[ 4] + u[0][ 4] * c + ss[ 6] * tt[ 8] + u[0][ 4] * c + ss[ 7] * tt[12] + u[0][ 4] * c;
  r[0][ 5] = ss[ 4] * tt[ 1] + u[0][ 5] * c + ss[ 5] * tt[ 5] + u[0][ 5] * c + ss[ 6] * tt[ 9] + u[0][ 5] * c + ss[ 7] * tt[13] + u[0][ 5] * c;
  r[0][ 6] = ss[ 4] * tt[ 2] + u[0][ 6] * c + ss[ 5] * tt[ 6] + u[0][ 6] * c + ss[ 6] * tt[10] + u[0][ 6] * c + ss[ 7] * tt[14] + u[0][ 6] * c;
  r[0][ 7] = ss[ 4] * tt[ 3] + u[0][ 7] * c + ss[ 5] * tt[ 7] + u[0][ 7] * c + ss[ 6] * tt[11] + u[0][ 7] * c + ss[ 7] * tt[15] + u[0][ 7] * c;
  r[0][ 8] = ss[ 8] * tt[ 0] + u[0][ 8] * c + ss[ 9] * tt[ 4] + u[0][ 8] * c + ss[10] * tt[ 8] + u[0][ 8] * c + ss[11] * tt[12] + u[0][ 8] * c;
  r[0][ 9] = ss[ 8] * tt[ 1] + u[0][ 9] * c + ss[ 9] * tt[ 5] + u[0][ 9] * c + ss[10] * tt[ 9] + u[0][ 9] * c + ss[11] * tt[13] + u[0][ 9] * c;
  r[0][10] = ss[ 8] * tt[ 2] + u[0][10] * c + ss[ 9] * tt[ 6] + u[0][10] * c + ss[10] * tt[10] + u[0][10] * c + ss[11] * tt[14] + u[0][10] * c;
  r[0][11] = ss[ 8] * tt[ 3] + u[0][11] * c + ss[ 9] * tt[ 7] + u[0][11] * c + ss[10] * tt[11] + u[0][11] * c + ss[11] * tt[15] + u[0][11] * c;
  r[0][12] = ss[12] * tt[ 0] + u[0][12] * c + ss[13] * tt[ 4] + u[0][12] * c + ss[14] * tt[ 8] + u[0][12] * c + ss[15] * tt[12] + u[0][12] * c;
  r[0][13] = ss[12] * tt[ 1] + u[0][13] * c + ss[13] * tt[ 5] + u[0][13] * c + ss[14] * tt[ 9] + u[0][13] * c + ss[15] * tt[13] + u[0][13] * c;
  r[0][14] = ss[12] * tt[ 2] + u[0][14] * c + ss[13] * tt[ 6] + u[0][14] * c + ss[14] * tt[10] + u[0][14] * c + ss[15] * tt[14] + u[0][14] * c;
  r[0][15] = ss[12] * tt[ 3] + u[0][15] * c + ss[13] * tt[ 7] + u[0][15] * c + ss[14] * tt[11] + u[0][15] * c + ss[15] * tt[15] + u[0][15] * c;
...
static inline void zm4x4_eq_spin_projection_zm4x4_11 (double _Complex **r, double _Complex **s, double alpha, double beta ) {

/* [spin_projection] Thu Jul 13 16:27:09 2017*/
...
static inline void zm4x4_eq_spin_projection_zm4x4_11 (double _Complex **r, double _Complex **s, double a, double b ) { 
  ...
  memcpy(ss, s[0], 16*sizeof(double));
