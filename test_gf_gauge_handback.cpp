...
int getPaddingForQuda ( QudaGaugeParam param )
{
  int pad = 0;
...
#pragma omp parallel
{
  ...
  /* gparam.tadpole_coeff = 0.0; */
  /* gparam.scale = 1.0; */

  gparam.type                          = QUDA_FLOWED_LINKS;
  gparam.gauge_order                   = QUDA_QDP_GAUGE_ORDER;

  gparam.t_boundary                    = QUDA_PERIODIC_T;

  gparam.cpu_prec                      = QUDA_DOUBLE_PRECISION;

  gparam.cuda_prec                     = QUDA_DOUBLE_PRECISION;
  gparam.reconstruct                   = QUDA_RECONSTRUCT_NO;

  gparam.cuda_prec_sloppy              = QUDA_SINGLE_PRECISION;
  gparam.reconstruct_sloppy            = QUDA_RECONSTRUCT_NO;

  gparam.cuda_prec_refinement_sloppy   = QUDA_SINGLE_PRECISION;
  gparam.reconstruct_refinement_sloppy = QUDA_RECONSTRUCT_NO;

  gparam.cuda_prec_precondition        = QUDA_HALF_PRECISION;
   
  gparam.reconstruct_precondition      = QUDA_RECONSTRUCT_NO;

  /* gparam.cuda_prec_eigensolver = QUDA_DOUBLE_PRECISION; */
                                                             
  /* gparam.reconstruct_eigensolver = QUDA_RECONSTRUCT_NO; */

  gparam.gauge_fix = QUDA_GAUGE_FIXED_NO;

  gparam.ga_pad = getPaddingForQuda ( gparam );
  ...
  /* gparam.llfat_ga_pad; */
  /* gparam.mom_ga_pad;   */
  /* gparam.staggered_phase_type; */
  /* gparam.staggered_phase_applied;  */
  /* gparam.i_mu; */
  /* gparam.overlap; */
  /* gparam.overwrite_mom; */
  /* gparam.use_resident_gauge  = QUDA_BOOLEAN_NO; */
  /* gparam.use_resident_mom    = QUDA_BOOLEAN_NO; */
  /* gparam.make_resident_gauge = QUDA_BOOLEAN_NO; */
  /* gparam.make_resident_mom   = QUDA_BOOLEAN_NO; */
  /* gparam.return_result_gauge = QUDA_BOOLEAN_NO; */
  /* gparam.return_result_mom   = QUDA_BOOLEAN_NO; */
  /* gparam.gauge_offset; */
  /* gparam.mom_offset;   */
  /* gparam.site_size;    */

  double ** quda_gauge_field = init_2level_dtable( 4, 18*VOLUME ) ;

  saveGaugeQuda( quda_gauge_field, &gparam );

  fini_2level_dtable ( &quda_gauge_field );
