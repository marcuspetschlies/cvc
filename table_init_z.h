...
inline double _Complex * init_1level_ztable ( unsigned int const N0 ) {
...
inline double _Complex ** init_2level_ztable (unsigned int const N0, unsigned int const N1 ) {
  ...
  for ( unsigned int i = 0; i < N0; i++ ) s_[i] = s__ + i * N1;
  return( s_ );
...
inline double _Complex *** init_3level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2 ) {
  double _Complex ** s__ = NULL;
...
inline double _Complex **** init_4level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3 ) {
  double _Complex *** s__ = NULL;
...
inline double _Complex ***** init_5level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4 ) {
  double _Complex **** s__ = NULL;
...
inline double _Complex ****** init_6level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5 ) {
  double _Complex ***** s__ = NULL;
...
inline double _Complex ******* init_7level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5, unsigned int const N6 ) {
  double _Complex ****** s__ = NULL;
...
inline double _Complex ******** init_8level_ztable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5, unsigned int const N6, unsigned int const N7 ) {
  double _Complex ******* s__ = NULL;
