...
int main( int argc, char *argv[]){
  ...
  int irrep_number[4]={2,1,1,1};

  irrep[0]=(char **)malloc(sizeof(char*)*2);
  irrep[1]=(char **)malloc(sizeof(char*)*1);
  irrep[2]=(char **)malloc(sizeof(char*)*1);
  irrep[3]=(char **)malloc(sizeof(char*)*1);
...
//        printf("(%d,%d,%d)\n",possible_mom_coord[total_momentum_x_index],possible_mom_coord[total_momentum_y_index],possible_mom_coord[total_momentum_z_index]);
        ...
        for (int irrep_index=0; irrep_index<irrep_number[total_momentum_magnitude]; ++irrep_index){
          ...
          printf("  particlenamesource = N\n");
          printf("  particlenamesink   = N\n");
          ...
          printf("  sinkspin  = 1\n");
          printf("  sourcespin = 1\n");
          printf("  listofgammasf1 = 14,4 11,5 8,4 2,5\n");
          printf("  listofgammasi1 = 14,4 11,5 8,4 2,5\n");
