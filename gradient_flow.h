...
void flow_fwd_gauge_spinor_field ( double * const g, double ** const phi, int const nf, unsigned int const niter, double const dt, int const flow_gauge, int const flow_spinor );
