...
inline double * init_1level_dtable ( unsigned int const N0 ) {
...
inline double ** init_2level_dtable (unsigned int const N0, unsigned int const N1 ) {
  double * s__ = NULL;
...
inline double *** init_3level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2 ) {
  double ** s__ = NULL;
...
inline double **** init_4level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3 ) {
  double *** s__ = NULL;
...
inline double ***** init_5level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4 ) {
  double **** s__ = NULL;
...
inline double ****** init_6level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5 ) {
  double ***** s__ = NULL;
...
inline double ******* init_7level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5, unsigned int const N6 ) {
  double ****** s__ = NULL;
...
inline double ******** init_8level_dtable (unsigned int const N0, unsigned int const N1, unsigned int const N2, unsigned int const N3, unsigned int const N4, unsigned int const N5, unsigned int const N6, unsigned int const N7 ) {
  double ******* s__ = NULL;
