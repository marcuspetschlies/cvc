...
void rot_printf_matrix_R (double _Complex **R, int creation_or_annihilation, int N, int **momtable, int momsize, int **spinf1table, int spin1sizelength, int spin12dim, char *A, FILE*ofs );

void rot_printf_matrix_python (double _Complex **R, int creation_or_annihilation, int N, int **momtable, int momsize, int **spinf1table, int spin1sizelength, int spin12dim, char *name, char *A, FILE*ofs );
