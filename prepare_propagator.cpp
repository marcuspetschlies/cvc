...
/*******************************************************************
 * point-to-all propagator, including smearing and residuum check
 *******************************************************************/
...
#  endif
    ...
    if ( check_residual ) {
      if ( mzz != NULL ) check_residual_clover ( &(spinor_work[1]), &(spinor_work[0]), gauge_field, mzz[op_id], mzzinv[op_id], 1 );
    }
